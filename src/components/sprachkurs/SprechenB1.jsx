...
function SprechenB1() {
    ...
    return (
        <div className="bg-palette-80 m-6 border-4 border-palette-50 rounded-xl flex justify-center items-center relative">
            <button
                onClick={() => navigate(-1)}
            ...
            <div className="bg-palette-50 p-10 border-4 border-palette-60 rounded-xl text-3xl text-center m-4 text-palette-60">
                Wir arbeiten an Übungen zu Sprachbausteine im Sprachniveau B1
            </div>
