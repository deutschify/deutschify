        ...
        <div className="bg-palette-60 p-4 mb-4">
            ...
            <div className="flex justify-center p-4 relative">
                <img
                    src={ContactA}
                    alt="contact us"
                    className="hidden md:block bg-palette-50 w-80 h-60 absolute left-60 rounded-xl bottom-72 border-8 border-palette-60 "
                />
                <form
                    onSubmit={sendEmail}
                ...
                <img
                    src={ContactB}
                    alt="contact us"
                    className="hidden md:block bg-palette-40 w-80 h-60 absolute right-60 bottom-24 border-8 border-palette-60 rounded-xl"
                />
            </div>
        </div>
    );
